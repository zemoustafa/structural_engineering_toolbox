...
def moment_interaction_design(
    ...
    v_bar_dia (float): diameter of vertical bars
    v_bar_cts (float): spacing of vertical bars
    h_bar_dia (float): diameter of horizontal bars (blade column) or ligatures
    bracing (str): bracing condition of column. Value must be 'Braced' or 'Unbraced'
    n_star_compression (float): applied axial load in compression
    n_star_tension (float): applied axial load in tension (must be a negative value)
